                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <p className="text-white/50 mb-6 leading-relaxed">
                            Experience the best of Himalayan camping with luxury, adventure, and peace. Your perfect mountain getaway awaits.
                        </p>
                    ...
                    {/* Cancellation Policy */}
                    <div>
                        <h4 className="text-white font-bold text-lg mb-6">Cancellation</h4>
                        <ul className="space-y-2 text-white/60 text-sm">
                            <li className="flex justify-between">
                                <span>7+ days before</span>
                                <span className="text-[#4CAF50]">90% refund</span>
                            </li>
                            <li className="flex justify-between">
                                <span>3-7 days before</span>
                                <span className="text-[#E86A33]">50% refund</span>
                            </li>
                            <li className="flex justify-between">
                                <span>Less than 3 days</span>
                                <span className="text-red-400">No refund</span>
                            </li>
                            <li className="pt-2 text-white/80 italic border-t border-white/10 mt-2">
                                Weather cancellation: <span className="text-[#4CAF50]">Full refund</span>
                            </li>
                        </ul>
                    </div>
                </div>
